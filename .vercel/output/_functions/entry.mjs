...
import { $ as fetchStateSymbol, A as renderEndpoint, B as isRoute404, F as sequence, G as BodySizeLimitError, H as MultiLevelEncodingError, I as copyRequest, J as ASTRO_GENERATOR, K as readBodyWithLimit, L as findRouteToRewrite, N as getRouteGenerator, P as RedirectSinglePageBuiltModule, Q as clientAddressSymbol, R as getOriginPathname, T as generateCspDigest, U as validateAndDecodePathname, V as isRoute500, W as NOOP_MIDDLEWARE_FN, X as REROUTABLE_STATUS_CODES, Y as REDIRECT_STATUS_CODES, Z as appSymbol, _t as slash, a as createConsoleLogger, at as collapseDuplicateLeadingSlashes, c as getParams, ct as fileExtension, d as getFallbackRoute, et as originPathnameSymbol, f as routeHasHtmlExtension, ft as joinPaths, g as getPattern, gt as removeTrailingForwardSlash, h as SERVER_ISLAND_COMPONENT, i as PipelineFeatures, it as appendForwardSlash, l as getProps, lt as hasFileExtension, m as routeIsRedirect, mt as removeLeadingForwardSlash, n as ALL_PIPELINE_FEATURES, nt as responseSentSymbol$1, o as AstroIntegrationLogger, ot as collapseDuplicateSlashes, p as routeIsFallback, pt as prependForwardSlash, q as ASTRO_ERROR_HEADER, r as Pipeline, rt as shouldAppendForwardSlash, s as routeComparator, st as collapseDuplicateTrailingSlashes, t as Slots, tt as pipelineSymbol, u as getCustom404Route, ut as isInternalPath, w as decodeKey, y as renderPage, z as setOriginPathname } from "./chunks/render_Q3oU-XgZ.mjs";
...
var middlewareSecret = "f7936763-98d0-4121-87a7-f414c4792dfc";
//#endregion
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"SITE": void 0,
			"SSR": true
		}, { _: "/home/vaqih/.nvm/versions/node/v22.22.3/bin/npm" })?.PROD) return {
...
function serializeActionResult(res) {
	if (res.error) {
		if (Object.assign({
			...
			"SITE": void 0,
			"SSR": true
		}, { _: "/home/vaqih/.nvm/versions/node/v22.22.3/bin/npm" })?.DEV) actionResultErrorStack.set(res.error.stack);
		let body2;
...
[
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/admin/builder.astro",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/builder.ts",
			"pathname": "/api/builder",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/resume.ts",
			"pathname": "/api/resume",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/labs.astro",
			"pathname": "/labs",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
...
var _page0 = () => import("./chunks/generic_ZlK_lvVw.mjs");
var _page1 = () => import("./chunks/builder_Bd-tTxXY.mjs");
var _page2 = () => import("./chunks/index_BWjIz7n_.mjs");
var _page3 = () => import("./chunks/auth_DwDp8z6e.mjs");
var _page4 = () => import("./chunks/builder_stxfPhzf.mjs");
var _page5 = () => import("./chunks/resume_DDUOROUE.mjs");
var _page6 = () => import("./chunks/_.._pBcrLR9-.mjs");
var _page7 = () => import("./chunks/_id__C8oQgP2Y.mjs");
var _page8 = () => import("./chunks/labs_CLcc2T27.mjs");
var _page9 = () => import("./chunks/_id__ClpIaXF2.mjs");
var _page10 = () => import("./chunks/projects_CNO0WO2q.mjs");
var _page11 = () => import("./chunks/resume_DxBJyJz8.mjs");
var _page12 = () => import("./chunks/index_CrkjSqYO.mjs");
var pageMap = /* @__PURE__ */ new Map([
	["node_modules/astro/dist/assets/endpoint/generic.js", _page0],
	["src/pages/admin/builder.astro", _page1],
	["src/pages/admin/index.astro", _page2],
	["src/pages/api/auth.ts", _page3],
	["src/pages/api/builder.ts", _page4],
	["src/pages/api/resume.ts", _page5],
	["src/pages/api/[...path].ts", _page6],
	["src/pages/labs/[id].astro", _page7],
	["src/pages/labs.astro", _page8],
	["src/pages/projects/[id].astro", _page9],
	["src/pages/projects.astro", _page10],
	["src/pages/resume.astro", _page11],
	["src/pages/index.astro", _page12]
]);
//#endregion
//#region \0virtual:astro:manifest
var _manifest = deserializeManifest({"rootDir":"file:///home/vaqih/workspace/portfoliovaqih-via-astro/","cacheDir":"file:///home/vaqih/workspace/portfoliovaqih-via-astro/node_modules/.astro/","outDir":"file:///home/vaqih/workspace/portfoliovaqih-via-astro/dist/","srcDir":"file:///home/vaqih/workspace/portfoliovaqih-via-astro/src/","publicDir":"file:///home/vaqih/workspace/portfoliovaqih-via-astro/public/","buildClientDir":"file:///home/vaqih/workspace/portfoliovaqih-via-astro/dist/client/","buildServerDir":"file:///home/vaqih/workspace/portfoliovaqih-via-astro/dist/server/","adapterName":"@astrojs/vercel","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"node_modules/astro/dist/assets/endpoint/generic.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.D3wr1T3t.css"}],"routeData":{"route":"/admin/builder","isIndex":false,"type":"page","pattern":"^\\/admin\\/builder\\/?$","segments":[[{"content":"admin","dynamic":false,"spread":false}],[{"content":"builder","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/admin/builder.astro","pathname":"/admin/builder","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.D3wr1T3t.css"}],"routeData":{"route":"/admin","isIndex":true,"type":"page","pattern":"^\\/admin\\/?$","segments":[[{"content":"admin","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/admin/index.astro","pathname":"/admin","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/auth","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/auth\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"auth","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/auth.ts","pathname":"/api/auth","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/builder","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/builder\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"builder","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/builder.ts","pathname":"/api/builder","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/resume","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/resume\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"resume","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/resume.ts","pathname":"/api/resume","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/[...path]","isIndex":false,"type":"endpoint","pattern":"^\\/api(?:\\/(.*?))?\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"...path","dynamic":true,"spread":true}]],"params":["...path"],"component":"src/pages/api/[...path].ts","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.D3wr1T3t.css"},{"type":"inline","content":"@media print{#global-loader[data-astro-cid-46m7bkbl]{display:none!important}}\n.prose h1{color:#0f172a;margin-top:2rem;margin-bottom:1rem;font-size:2.25rem;font-weight:800;line-height:1.2}.prose h2{color:#0f172a;margin-top:2rem;margin-bottom:1rem;font-size:1.5rem;font-weight:700;line-height:1.33}.prose h3{color:#0f172a;margin-top:1.5rem;margin-bottom:.5rem;font-size:1.25rem;font-weight:600;line-height:1.6}.prose p{color:#334155;margin-top:1.25rem;margin-bottom:1.25rem;line-height:1.75}.prose a{font-weight:500;text-decoration:underline}.prose img{max-width:100%;height:auto;margin-top:2rem;margin-bottom:2rem}.prose ul{margin-top:1.25rem;margin-bottom:1.25rem;padding-left:1.625em;list-style-type:disc}.prose ol{margin-top:1.25rem;margin-bottom:1.25rem;padding-left:1.625em;list-style-type:decimal}.prose li{margin-top:.5rem;margin-bottom:.5rem}.prose blockquote{color:#1e293b;quotes:\"“\"\"”\"\"‘\"\"’\";border-left-width:.25rem;border-left-color:#cbd5e1;margin-top:1.6em;margin-bottom:1.6em;padding-left:1em;font-style:italic;font-weight:500}.prose code{color:#0f172a;background-color:#f1f5f9;border-radius:.25rem;padding:.2em .4em;font-size:.875em;font-weight:600}.prose pre{color:#e2e8f0;background-color:#1e293b;border-radius:.375rem;margin-top:1.71429em;margin-bottom:1.71429em;padding:.857143em 1.14286em;font-size:.875em;line-height:1.71429;overflow-x:auto}.prose pre code{font-weight:inherit;color:inherit;font-size:inherit;font-family:inherit;line-height:inherit;background-color:#0000;border-width:0;border-radius:0;padding:0}.prose hr{border-color:#e2e8f0;border-top-width:1px;margin-top:3em;margin-bottom:3em}\n"}],"routeData":{"route":"/labs/[id]","isIndex":false,"type":"page","pattern":"^\\/labs\\/([^/]+?)\\/?$","segments":[[{"content":"labs","dynamic":false,"spread":false}],[{"content":"id","dynamic":true,"spread":false}]],"params":["id"],"component":"src/pages/labs/[id].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.D3wr1T3t.css"},{"type":"inline","content":"@media print{#global-loader[data-astro-cid-46m7bkbl]{display:none!important}}\n.hide-scrollbar[data-astro-cid-nidsnqhu]::-webkit-scrollbar{display:none}.hide-scrollbar[data-astro-cid-nidsnqhu]{-ms-overflow-style:none;scrollbar-width:none}\n"}],"routeData":{"route":"/labs","isIndex":false,"type":"page","pattern":"^\\/labs\\/?$","segments":[[{"content":"labs","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/labs.astro","pathname":"/labs","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.D3wr1T3t.css"},{"type":"inline","content":"@media print{#global-loader[data-astro-cid-46m7bkbl]{display:none!important}}\n.prose h1{color:#0f172a;margin-top:2rem;margin-bottom:1rem;font-size:2.25rem;font-weight:800;line-height:1.2}.prose h2{color:#0f172a;margin-top:2rem;margin-bottom:1rem;font-size:1.5rem;font-weight:700;line-height:1.33}.prose h3{color:#0f172a;margin-top:1.5rem;margin-bottom:.5rem;font-size:1.25rem;font-weight:600;line-height:1.6}.prose p{color:#334155;margin-top:1.25rem;margin-bottom:1.25rem;line-height:1.75}.prose a{font-weight:500;text-decoration:underline}.prose img{max-width:100%;height:auto;margin-top:2rem;margin-bottom:2rem}.prose ul{margin-top:1.25rem;margin-bottom:1.25rem;padding-left:1.625em;list-style-type:disc}.prose ol{margin-top:1.25rem;margin-bottom:1.25rem;padding-left:1.625em;list-style-type:decimal}.prose li{margin-top:.5rem;margin-bottom:.5rem}.prose blockquote{color:#1e293b;quotes:\"“\"\"”\"\"‘\"\"’\";border-left-width:.25rem;border-left-color:#cbd5e1;margin-top:1.6em;margin-bottom:1.6em;padding-left:1em;font-style:italic;font-weight:500}.prose code{color:#0f172a;background-color:#f1f5f9;border-radius:.25rem;padding:.2em .4em;font-size:.875em;font-weight:600}.prose pre{color:#e2e8f0;background-color:#1e293b;border-radius:.375rem;margin-top:1.71429em;margin-bottom:1.71429em;padding:.857143em 1.14286em;font-size:.875em;line-height:1.71429;overflow-x:auto}.prose pre code{font-weight:inherit;color:inherit;font-size:inherit;font-family:inherit;line-height:inherit;background-color:#0000;border-width:0;border-radius:0;padding:0}.prose hr{border-color:#e2e8f0;border-top-width:1px;margin-top:3em;margin-bottom:3em}\n"}],"routeData":{"route":"/projects/[id]","isIndex":false,"type":"page","pattern":"^\\/projects\\/([^/]+?)\\/?$","segments":[[{"content":"projects","dynamic":false,"spread":false}],[{"content":"id","dynamic":true,"spread":false}]],"params":["id"],"component":"src/pages/projects/[id].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.D3wr1T3t.css"},{"type":"inline","content":"@media print{#global-loader[data-astro-cid-46m7bkbl]{display:none!important}}\n.hide-scrollbar[data-astro-cid-3rkrlumz]::-webkit-scrollbar{display:none}.hide-scrollbar[data-astro-cid-3rkrlumz]{-ms-overflow-style:none;scrollbar-width:none}\n"}],"routeData":{"route":"/projects","isIndex":false,"type":"page","pattern":"^\\/projects\\/?$","segments":[[{"content":"projects","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/projects.astro","pathname":"/projects","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.D3wr1T3t.css"},{"type":"inline","content":"@media print{#global-loader[data-astro-cid-46m7bkbl]{display:none!important}}\nbody:has(main)>footer:not(main footer){display:none!important}@media print{@page{margin:0;size:A4}html,body{-webkit-print-color-adjust:exact;color:#000!important;background:#fff!important;width:100%!important;height:auto!important;display:block!important;position:static!important;overflow:visible!important}body>div{width:100%!important;height:auto!important;display:block!important;position:static!important}header.sticky{z-index:1000!important;background:#fff!important;border-bottom:1px solid #e2e8f0!important;width:100%!important;height:60px!important;padding-left:40px!important;padding-right:40px!important;display:block!important;position:fixed!important;top:0!important;left:0!important}header.sticky>div{width:100%!important;max-width:100%!important;padding-left:0!important;padding-right:0!important}footer{z-index:1000!important;background:#fff!important;border-top:1px solid #e2e8f0!important;width:100%!important;height:120px!important;padding-left:40px!important;padding-right:40px!important;display:block!important;position:fixed!important;bottom:0!important;left:0!important}footer>footer{border-top:none!important;width:100%!important;max-width:100%!important;padding-left:0!important;padding-right:0!important}footer .flex-col,footer>footer>div{flex-direction:row!important;justify-content:space-between!important;align-items:center!important;width:100%!important}.print\\:hidden,button,a[aria-label=GitHub],a[aria-label=LinkedIn]{display:none!important}.font-serif{height:auto!important}.print-break-before{break-before:page!important;page-break-before:always!important}}\n"}],"routeData":{"route":"/resume","isIndex":false,"type":"page","pattern":"^\\/resume\\/?$","segments":[[{"content":"resume","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/resume.astro","pathname":"/resume","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.D3wr1T3t.css"},{"type":"inline","content":"@media print{#global-loader[data-astro-cid-46m7bkbl]{display:none!important}}\n"}],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["/home/vaqih/workspace/portfoliovaqih-via-astro/src/pages/labs.astro",{"propagation":"none","containsHead":true}],["/home/vaqih/workspace/portfoliovaqih-via-astro/src/pages/projects.astro",{"propagation":"none","containsHead":true}],["/home/vaqih/workspace/portfoliovaqih-via-astro/src/pages/resume.astro",{"propagation":"none","containsHead":true}],["/home/vaqih/workspace/portfoliovaqih-via-astro/src/pages/index.astro",{"propagation":"none","containsHead":true}],["/home/vaqih/workspace/portfoliovaqih-via-astro/src/pages/labs/[id].astro",{"propagation":"none","containsHead":true}],["/home/vaqih/workspace/portfoliovaqih-via-astro/src/pages/projects/[id].astro",{"propagation":"none","containsHead":true}],["/home/vaqih/workspace/portfoliovaqih-via-astro/src/pages/admin/builder.astro",{"propagation":"none","containsHead":true}],["/home/vaqih/workspace/portfoliovaqih-via-astro/src/pages/admin/index.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"astro/entrypoints/prerender":"prerender-entry.CZH0tp_I.mjs","\u0000virtual:astro:middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_C-PI1Pas.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","/home/vaqih/workspace/portfoliovaqih-via-astro/node_modules/@astrojs/react/dist/vnode-children.js":"chunks/vnode-children_B6vVcKTz.mjs","@astrojs/vercel/entrypoint":"entry.mjs","\u0000virtual:astro:page:src/pages/api/[...path]@_@ts":"chunks/_.._pBcrLR9-.mjs","\u0000virtual:astro:page:src/pages/labs/[id]@_@astro":"chunks/_id__C8oQgP2Y.mjs","\u0000virtual:astro:page:src/pages/projects/[id]@_@astro":"chunks/_id__ClpIaXF2.mjs","\u0000virtual:astro:page:src/pages/api/auth@_@ts":"chunks/auth_DwDp8z6e.mjs","\u0000virtual:astro:page:src/pages/admin/builder@_@astro":"chunks/builder_Bd-tTxXY.mjs","\u0000virtual:astro:page:src/pages/api/builder@_@ts":"chunks/builder_stxfPhzf.mjs","\u0000virtual:astro:page:node_modules/astro/dist/assets/endpoint/generic@_@js":"chunks/generic_ZlK_lvVw.mjs","\u0000virtual:astro:page:src/pages/admin/index@_@astro":"chunks/index_BWjIz7n_.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_CrkjSqYO.mjs","\u0000virtual:astro:page:src/pages/labs@_@astro":"chunks/labs_CLcc2T27.mjs","\u0000virtual:astro:page:src/pages/projects@_@astro":"chunks/projects_CNO0WO2q.mjs","\u0000virtual:astro:page:src/pages/api/resume@_@ts":"chunks/resume_DDUOROUE.mjs","\u0000virtual:astro:page:src/pages/resume@_@astro":"chunks/resume_DxBJyJz8.mjs","/home/vaqih/workspace/portfoliovaqih-via-astro/node_modules/astro/dist/assets/services/sharp.js":"chunks/sharp_fwt7jLgV.mjs","/home/vaqih/workspace/portfoliovaqih-via-astro/src/components/ContributionHeatmap":"_astro/ContributionHeatmap.De2cjKQQ.js","/home/vaqih/workspace/portfoliovaqih-via-astro/src/components/LoadingScreen.astro?astro&type=script&index=0&lang.ts":"_astro/LoadingScreen.astro_astro_type_script_index_0_lang.DV5Y9mlA.js","/home/vaqih/workspace/portfoliovaqih-via-astro/src/components/resume-builder/ResumeBuilderApp":"_astro/ResumeBuilderApp.CFzobGCU.js","/home/vaqih/workspace/portfoliovaqih-via-astro/src/components/VelocityScroll.tsx":"_astro/VelocityScroll.DFrnRqho.js","@astrojs/react/client.js":"_astro/client.Bv3O21T9.js","/home/vaqih/workspace/portfoliovaqih-via-astro/src/components/footer.tsx":"_astro/footer.ChhAyL_Q.js","/home/vaqih/workspace/portfoliovaqih-via-astro/src/pages/admin/index.astro?astro&type=script&index=0&lang.ts":"_astro/index.astro_astro_type_script_index_0_lang.BfnZ2EX7.js","/home/vaqih/workspace/portfoliovaqih-via-astro/src/pages/index.astro?astro&type=script&index=0&lang.ts":"_astro/index.astro_astro_type_script_index_0_lang.DJaPeHoe.js","/home/vaqih/workspace/portfoliovaqih-via-astro/src/pages/labs.astro?astro&type=script&index=0&lang.ts":"_astro/labs.astro_astro_type_script_index_0_lang.S3S1nJFA.js","/home/vaqih/workspace/portfoliovaqih-via-astro/src/pages/projects.astro?astro&type=script&index=0&lang.ts":"_astro/projects.astro_astro_type_script_index_0_lang.Bzhw6cjQ.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[["/home/vaqih/workspace/portfoliovaqih-via-astro/src/components/LoadingScreen.astro?astro&type=script&index=0&lang.ts","var e=[{type:`info`,text:`Initializing cloud deployment pipeline...`},{type:`info`,text:`Locating state backend: s3://vaqih-tf-state...`},{type:`success`,text:`State locked successfully. Version: 1.8.2`},{type:`warn`,text:`Warning: 3 modules have pending updates.`},{type:`info`,text:`Applying changes to vpc-network (google_compute_network)...`},{type:`success`,text:`Network route tables configured.`},{type:`info`,text:`Creating kubernetes-cluster (google_container_node_pool)...`},{type:`info`,text:`Configuring ingress controller & SSL certificates...`},{type:`success`,text:`DNS mapped: vaqih.dev -> 185.199.110.153`},{type:`info`,text:`Injecting Zero-Trust IAM roles & security policies...`},{type:`success`,text:`All nodes healthy. Deployment completed!`}],t=[`INITIALIZING SYSTEM...`,`CONNECTING BACKEND...`,`PROVISIONING NETWORKS...`,`SPAWNING K8S NODES...`,`SECURING CREDENTIALS...`,`READY`],n=document.getElementById(`global-loader`),r=document.getElementById(`loader-console`),i=document.getElementById(`loader-progress-bar`),a=document.getElementById(`loader-status-text`),o=document.getElementById(`loader-pct`);if(n&&r&&i&&a&&o){let s=0,c=0,l=!1;window.addEventListener(`load`,()=>{l=!0});let u=setTimeout(()=>{l=!0},4e3);function d(e){if(!r)return;let t=document.createElement(`div`),n=``;e.type===`info`?n=`<span class=\"text-blue-400 font-bold\">[INFO]</span>`:e.type===`success`?n=`<span class=\"text-emerald-400 font-bold\">[OK]</span>`:e.type===`warn`&&(n=`<span class=\"text-amber-500 font-bold\">[WARN]</span>`),t.innerHTML=`${n} ${e.text}`,r.appendChild(t),r.scrollTop=r.scrollHeight}function f(){if(!(!i||!o||!a||!n))if(s<e.length&&(d(e[s]),s++),c<85?(c+=Math.floor(Math.random()*12)+5,c>85&&(c=85)):l&&c<100&&(c+=5),c>100&&(c=100),i.style.width=`${c}%`,o.textContent=`${c}%`,a.textContent=t[Math.min(Math.floor(c/100*t.length),t.length-1)],c<100||!l){let e=Math.random()*200+150;setTimeout(f,e)}else a.textContent=`READY`,d({type:`success`,text:`System initialized. Loading UI...`}),clearTimeout(u),setTimeout(()=>{n.classList.add(`opacity-0`,`pointer-events-none`),setTimeout(()=>{n.style.display=`none`},700)},500)}f()}"],["/home/vaqih/workspace/portfoliovaqih-via-astro/src/pages/index.astro?astro&type=script&index=0&lang.ts","document.addEventListener(`DOMContentLoaded`,()=>{let e=document.getElementById(`terminal-box`),t=document.getElementById(`terminal-hidden-input`),n=document.getElementById(`terminal-input-display`),r=document.getElementById(`admin-modal`),i=document.getElementById(`auth-form`),a=document.getElementById(`auth-error`),o=document.getElementById(`auth-cancel`);!e||!t||!n||(e.addEventListener(`click`,()=>{t.focus()}),t.addEventListener(`input`,e=>{n.innerText=e.target.value}),t.addEventListener(`keydown`,e=>{if(e.key===`Enter`){let e=t.value.trim().toLowerCase();if(e===`admin`){if(r){r.classList.remove(`hidden`);let e=document.querySelector(`#admin-modal input[name=\"username\"]`);e&&setTimeout(()=>e.focus(),100)}}else e===`clear`||e===`cls`?(n.innerText=``,t.value=``):e!==``&&(alert(`>_ Command \"${e}\" not found inside vaqihdev core kernel function ecosystem.`),n.innerText=``,t.value=``)}}),o&&r&&o.addEventListener(`click`,()=>{r.classList.add(`hidden`),a&&a.classList.add(`hidden`)}),i&&i.addEventListener(`submit`,async e=>{e.preventDefault(),a&&a.classList.add(`hidden`);let t=new FormData(i),n=t.get(`username`),r=t.get(`password`);try{let e=await fetch(`/api/auth`,{method:`POST`,headers:{\"Content-Type\":`application/json`},body:JSON.stringify({username:n,password:r})}),t=await e.json();e.ok&&t.success?window.location.href=`/admin`:a&&(a.innerText=t.message||`INVALID CREDENTIALS`,a.classList.remove(`hidden`))}catch{a&&(a.innerText=`NETWORK ERROR`,a.classList.remove(`hidden`))}}))});"],["/home/vaqih/workspace/portfoliovaqih-via-astro/src/pages/labs.astro?astro&type=script&index=0&lang.ts","document.addEventListener(`DOMContentLoaded`,()=>{let e=document.querySelectorAll(`.category-btn`),t=document.querySelectorAll(`.lab-card`),n=document.getElementById(`empty-state`);e.forEach(r=>{r.addEventListener(`click`,()=>{e.forEach(e=>{e.classList.remove(`bg-blue-50`,`text-blue-700`,`dark:bg-blue-900/30`,`dark:text-blue-400`),e.classList.add(`text-slate-600`,`dark:text-slate-400`,`hover:bg-slate-100`,`dark:hover:bg-slate-800`)}),r.classList.remove(`text-slate-600`,`dark:text-slate-400`,`hover:bg-slate-100`,`dark:hover:bg-slate-800`),r.classList.add(`bg-blue-50`,`text-blue-700`,`dark:bg-blue-900/30`,`dark:text-blue-400`);let i=r.getAttribute(`data-category`),a=0;t.forEach(e=>{let t=(e.getAttribute(`data-categories`)||``).split(`,`);i===`all`||t.includes(i)?(e.style.display=`flex`,a++):e.style.display=`none`}),n&&(n.style.display=a===0?`block`:`none`)})})});"],["/home/vaqih/workspace/portfoliovaqih-via-astro/src/pages/projects.astro?astro&type=script&index=0&lang.ts","document.addEventListener(`DOMContentLoaded`,()=>{let e=document.querySelectorAll(`.category-btn`),t=document.querySelectorAll(`.project-card`),n=document.getElementById(`empty-state`);e.forEach(r=>{r.addEventListener(`click`,()=>{e.forEach(e=>{e.classList.remove(`bg-blue-50`,`text-blue-700`,`dark:bg-blue-900/30`,`dark:text-blue-400`),e.classList.add(`text-slate-600`,`dark:text-slate-400`,`hover:bg-slate-100`,`dark:hover:bg-slate-800`)}),r.classList.remove(`text-slate-600`,`dark:text-slate-400`,`hover:bg-slate-100`,`dark:hover:bg-slate-800`),r.classList.add(`bg-blue-50`,`text-blue-700`,`dark:bg-blue-900/30`,`dark:text-blue-400`);let i=r.getAttribute(`data-category`),a=0;t.forEach(e=>{let t=(e.getAttribute(`data-categories`)||``).split(`,`);i===`all`||t.includes(i)?(e.style.display=`flex`,a++):e.style.display=`none`}),n&&(n.style.display=a===0?`block`:`none`)})})});"]],"assets":["/favicon.ico","/favicon.svg","/_astro/ContributionHeatmap.De2cjKQQ.js","/_astro/ResumeBuilderApp.CFzobGCU.js","/_astro/VelocityScroll.DFrnRqho.js","/_astro/client.Bv3O21T9.js","/_astro/footer.BUOjD1RX.js","/_astro/footer.ChhAyL_Q.js","/_astro/index.astro_astro_type_script_index_0_lang.BfnZ2EX7.js","/_astro/jsx-runtime.DuCIhyLr.js","/_astro/react.Ca03aNmg.js","/images/cloud-datacenter-banner.png","/images/cloud-hero.png","/images/cloud-sketch-bg.png","/images/labs-banner.png","/images/mslearn-banner.png","/images/profile-banner.png","/images/projects-banner.png","/_astro/global.D3wr1T3t.css","/_astro/geist-cyrillic-ext-wght-normal.DjL33-gN.woff2","/_astro/geist-cyrillic-wght-normal.BEAKL7Jp.woff2","/_astro/geist-vietnamese-wght-normal.6IgcOCM7.woff2","/_astro/geist-latin-ext-wght-normal.DC-KSUi6.woff2","/_astro/geist-latin-wght-normal.BgDaEnEv.woff2"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"l9ddxw9XnOAKdmkhYT9Ywxw3rusJz7vZwiOa9KTYoNo=","image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
